...
**Stellar-specific:**
- `~/.Codex/skills/data/lumenloop/projects.json` — 728-project Stellar ecosystem catalog with categories, SCF funding history, GitHub links
- `~/.Codex/skills/data/electric-capital/stellar-repos.json` — Stellar developer activity signal (~9000 repos)
- `~/.Codex/skills/data/lumenloop/scf/rounds.json` — historical SCF funding patterns (categories funded, average grant size)

**Broader crypto market signals:**
- `~/.Codex/skills/data/ideas/a16z-big-ideas-2025.json` — a16z's published "big ideas" thesis for 2025
- `~/.Codex/skills/data/ideas/a16z-state-of-crypto-2025.json` — a16z's annual State of Crypto report
- `~/.Codex/skills/data/ideas/yc-requests-for-startups.json` — YC's published Request for Startups list (what YC explicitly wants funded)
- `~/.Codex/skills/data/ideas/yc-crypto-companies.json` — every YC-backed crypto company (competitive map + signal of what gets funded)
- `~/.Codex/skills/data/ideas/alliance-ideas.json` — Alliance DAO's startup ideas
